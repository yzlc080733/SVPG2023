...
class RWTA_Spike:
    def __init__(self,
                ...
                spk_response_window='uni',                  # 'uni', 'dexp'
                spk_full_time=200, spk_resp_time=50,
        ...
        print_info('RWTA Spk initialize')
    ...
    def forward(self, x):
        ...
        # return [output, [act_sample, act_logprob, prob_record, spike_record, action_dist_entropy]]
    ...
    def random_remove_weight(self, noise_type, noise_param):
        ...
        if noise_type == 'sh':
            ...
            index_1x_h, index_1y_h = torch.triu_indices(self.dim_h, self.dim_h)
